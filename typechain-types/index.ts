...
export type { RaffleContract } from "./contracts/Raffle.sol/RaffleContract";
export { RaffleContract__factory } from "./factories/contracts/Raffle.sol/RaffleContract__factory";
